...
//export const PRICE_PER_BRICK = 0.2 * LAMPORTS_PER_SOL;
export const PRICE_PER_BRICK = 0.001 * LAMPORTS_PER_SOL;
export const PRICE_PER_BRICK_EDIT = 0.001 * LAMPORTS_PER_SOL;
